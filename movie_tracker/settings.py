...
# The URL name 'next_movie' is defined in tracker/urls.py as path('', views.next_movie_view, name='next_movie').
LOGIN_REDIRECT_URL = 'next_movie' 

# The LOGIN_URL is also important, defined by its URL name 'login' 
# (which is part of django.contrib.auth.urls).
LOGIN_URL = 'login' 

JAZZMIN_SETTINGS = {
    # Title on the login screen (useful for branding)
    "site_title": "HaveYouSeenIt Admin",

    # Title on the brand (logo) area
    "site_header": "HaveYouSeenIt",

    # The model admin list is default compact, making it harder to click on
    "list_filter_actions_on_top": True,
    
    # Logo to use for your site, must be present in static files
    "site_logo": None, # You can add a path to a logo file here e.g. "myapp/img/logo.png"
